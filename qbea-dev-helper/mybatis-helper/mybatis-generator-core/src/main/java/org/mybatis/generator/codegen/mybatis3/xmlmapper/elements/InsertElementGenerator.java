        ...
        if (gk != null) {
            ...
            if (introspectedColumn != null) {
                if (gk.isJdbcStandard()) {
                    ...
                    /** qbea @todo selectKey 目前支持mysql、postgresql **/
                    answer.addElement(getMysqlSelectKey(introspectedColumn, gk));
                    answer.addElement(getPostgreSqlSelectKey(introspectedColumn, gk));
                }
            }
        }
